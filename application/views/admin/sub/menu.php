              ...
              <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse pull-right">
                  ...
                  <ul class="nav navbar-nav">
                    ...
                    <li><a class="is-active" href="<?php echo base_url('Admin'); ?>">BERANDA</a></li>
                    <li><a href="<?php echo site_url('Admin/datapendaftaran')?>">DATA PENDAFTARAN</a></li>
                    <li><a href="<?php echo site_url('Admin/datalembaga')?>">DATA LEMBAGA</a></li>
                    <li><a href="<?php echo site_url('Admin/datadonasi')?>">DATA DONASI</a></li>
