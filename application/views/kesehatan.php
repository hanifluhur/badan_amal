		...
		<nav class="navbar navbar-fixed-top navbar-default" role="navigation">
			...
			<div class="jumbotron">
				<div class="container">
					...
					<img class="img-thumbnail" src="<?php echo base_url('assets/gambar8.jpg'); ?>">
					<p>Di bidang kesehatan, Dompet Dhuafa telah berperan aktif dalam melayani kaum dhuafa sejak tahun 2001. Melalui program Layanan Kesehatan Cuma-cuma (LKC), beragam kegiatan telah dilakukan, baik bersifat preventif, promotif dan kuratif.

					Sejak tahun 2009, Dompet Dhuafa membangun rumah sakit gratis bagi pasien dari kalangan masyarakat miskin. Berlokasi di Desa Jampang, Kemang, Kabupaten Bogor, di atas lahan seluas 7,600 m2. RST memiliki fasilitas lengkap, mulai dari poliklinik, dokter spesialis, ruang operasi, rawat inap, UGD, apotek, hingga metode pengobatan komplementer</p>
					<p><br>
					</p>
				</div>
			</div>
