	...
	<body>
		...
		<nav class="navbar navbar-fixed-top navbar-default" role="navigation">
			...
			<div class="jumbotron">
				<div class="container">
					<br><br>
					<h2>Profil Kemiskinan</h2>
					<br><br>
					<p>Masalah sosial yang dihadapi bangsa ini sejak dulu adalah kemiskinan. Berbagai program dan kebijakan yang telah dilakukan belum mampu mengatasi masalah kemiskinan di negeri ini.</p>
					<img class="img-thumbnail" src="<?php echo base_url('assets/gambar9.jpg'); ?>">
					<p>Meski pertumbuhan ekonomi melesat namun Indonesia masih diselimuti kemiskinan yang dahsyat. Untuk itu Dompet Dhuafa mendirikan divisi ekonomi dengan jejaring yang tersebar di hampir seluruh pelosok Indonesia. Tujuannya adalah untuk mendampingi masyarakat melalui berbagai program yang disesuaikan dengan daerahnya agar tercipta lahan-lahan pekerjaan baru serta masyarakat yang berdaya sehingga mereka dapat mandiri secara finansial.</p>
					<p><br>
					</p>
				</div>
			</div>
